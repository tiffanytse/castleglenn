...
function twentytwelve_entry_meta() {
	...
	if ( $tag_list ) {
		$utility_text = __( '<div class="meta-info"><span class="by-author">%4$s</span>  %3$s <span class="tags"> %2$s </span></div>', 'twentytwelve' );
	} elseif ( $categories_list ) {
		$utility_text = __( '<div class="meta-info"><span class="by-author">%4$s</span> %3$s</div>', 'twentytwelve' );
	} else {
